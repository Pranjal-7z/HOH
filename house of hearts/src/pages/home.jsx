  ...
  return (
    <div className="all">
      ...
      <div className="cards-container">
        <div className="card card1"><div className="card-name"><h6>VARUN</h6></div><div className="card-position"></div></div>
        <div className="card card2"><div className="card-name"><h6>AJAY</h6></div><div className="card-position"></div></div>
        <div className="card card3"><div className="card-name"><h6>CHETAN</h6></div><div className="card-position"></div></div>
      </div>
